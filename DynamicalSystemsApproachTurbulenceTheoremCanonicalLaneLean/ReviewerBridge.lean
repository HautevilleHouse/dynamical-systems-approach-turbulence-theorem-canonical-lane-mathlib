...
def reviewerManifestEntries : List ReviewerManifestEntry :=
  ...
  { path := "paper/DYNAMICAL_SYSTEMS_APPROACH_TURBULENCE_PREPRINT.md", sha256 := "9b896ba7f6120a7438aadb95d0dfcdd1ad2e2c40810b66a2df4ca7adb1903104" },
  ...
  { path := "scripts/ds_closure_guard.py", sha256 := "17ba17144c28930118af9070d29f1b3af5b107797ce8e8eb8abd508cbebd6997" },
  { path := "scripts/promote_constants.py", sha256 := "b65eb7a60552c668f04d6331a5256fe4e662ae5e83e769d42f6a141819769356" }]

def baselineCertificateGates : List CertificateGate :=
  [{ gate := "D_G1", status := "PASS" },
  { gate := "D_G2", status := "PASS" },
  { gate := "D_G3", status := "PASS" },
  { gate := "D_G4", status := "PASS" },
  { gate := "D_G5", status := "PASS" },
  { gate := "D_G6", status := "PASS" },
  { gate := "D_GM", status := "PASS" }]
